...
('home','entrance_intro','首頁｜三大入口說明','multiline','初次接觸調香，可以從 HELORI 香氣探索體驗開始；想深入學習的人進入專業調香課程；品牌、空間與企業團體合作，進入嗅覺設計服務。',50),
('home','about_title','首頁｜關於 Hana 標題','text','Hana 沈秉儀｜嗅覺藝術家',60),
...
('atelier','hero_intro','氣味作品｜頁首說明','multiline','香氣的呈現形式有很多種，在這裡，承接了 HANA SCENT ARTIST 的嗅覺敘事方法，將記憶、場域與情緒轉化為可以被收藏、使用與帶走的香氣作品。',10),
('atelier','statement_title','氣味作品｜品牌宣言標題','multiline','氣味不只是一昧的流行，而是千年來記憶被直接保存的方式。',20),
('atelier','statement_intro','氣味作品｜品牌宣言說明','multiline','先理解你想被如何記得，再將記憶轉譯成可以被聞見的結構。',30),
