document.addEventListener("DOMContentLoaded", () => {
  ...
  if (isHomepage && !document.getElementById("intro-screen")) {
    ...
    fallbackStyle.textContent = '.intro-open{overflow:hidden!important}.intro-screen-fallback{position:fixed;inset:0;width:100%;height:100dvh;z-index:1000;display:grid;place-items:center;overflow:hidden;background:#fff;transition:opacity .7s ease,visibility .7s ease}.intro-screen-fallback.is-leaving{opacity:0;visibility:hidden;pointer-events:none}.intro-screen-fallback .intro-slides{position:absolute;inset:0;overflow:hidden}.intro-screen-fallback .intro-slide{position:absolute;inset:0;margin:0;opacity:0;animation:hanaIntroSequence 15s ease-in-out infinite}.intro-screen-fallback .intro-slide:nth-child(1){--hanaFrom:-4%;--hanaTo:2%;animation-delay:0s}.intro-screen-fallback .intro-slide:nth-child(2){--hanaFrom:4%;--hanaTo:-2%;animation-delay:5s}.intro-screen-fallback .intro-slide:nth-child(3){--hanaFrom:-4%;--hanaTo:2%;animation-delay:10s}.intro-screen-fallback img{width:100%;height:100%;object-fit:cover;filter:saturate(.82) contrast(.96)}.intro-screen-fallback .intro-enter{position:absolute;z-index:2;left:50%;bottom:calc(env(safe-area-inset-bottom) + 70px);transform:translateX(-50%);padding:10px 18px;border:1px solid #111;background:rgba(255,255,255,.92);color:#111;font-family:serif;font-size:13px;letter-spacing:.24em}@keyframes hanaIntroSequence{0%{opacity:0;transform:translateX(var(--hanaFrom)) scale(1.04)}8%{opacity:1}28%{opacity:1}36%{opacity:0;transform:translateX(var(--hanaTo)) scale(1.08)}100%{opacity:0;transform:translateX(var(--hanaTo)) scale(1.08)}}';    document.head.appendChild(fallbackStyle);
