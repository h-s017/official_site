(() => {
  ...
  const installGlobalStyle = () => {
    ...
    style.textContent = `
      ...
      .footer-social-col{display:flex!important;align-items:flex-start!important;justify-content:flex-start!important;text-align:left!important;padding:4px 0 0!important}.footer-social-links{display:flex;align-items:center;gap:20px;flex-wrap:wrap}.footer-social-link{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:30px;height:30px;border:0!important}.footer-social-link img{display:block;width:26px;height:26px;object-fit:contain}.footer-right-col .footer-actions{display:flex!important;flex-direction:column!important;align-items:flex-start!important;gap:11px!important}.footer-right-col .footer-action{display:inline!important;width:auto!important;padding:0!important;border:0!important;background:transparent!important;color:inherit!important;box-shadow:none!important;text-decoration:none!important}.footer-course-info{grid-column:1/-1;margin-top:42px;padding-top:28px;border-top:1px solid var(--line)}.footer-course-kicker{margin:0 0 10px;color:var(--gray500);font-size:11px;letter-spacing:.2em;text-transform:uppercase}.footer-course-title{margin:0 0 18px;font-size:18px;font-weight:500;letter-spacing:.06em}.footer-course-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:0 36px}.footer-course-item{padding:12px 0;border-top:1px solid var(--line);font-size:13px;line-height:1.8}.footer-course-item strong{display:block;margin-bottom:2px;font-weight:500}.footer-bottom{grid-column:1/-1;display:flex;justify-content:space-between;gap:24px;margin-top:42px;padding-top:18px;border-top:1px solid var(--line);color:var(--gray500);font-size:12px}.footer-legal{text-align:right}.footer-legal a{white-space:nowrap}
      @media(max-width:900px){.footer-grid{grid-template-columns:minmax(0,1.25fr) minmax(160px,.75fr)!important;column-gap:42px!important;row-gap:34px!important}.footer-right-col{grid-column:2;grid-row:1}.footer-social-col{grid-column:1/-1;grid-row:2}.footer-course-info{grid-row:3}.footer-bottom{grid-row:4}}
      @media(max-width:760px){.footer-grid{display:block!important}.footer-brand-col,.footer-social-col,.footer-right-col{margin:0 0 30px!important}.footer-course-info{margin-top:24px;padding-top:24px}.footer-course-grid{grid-template-columns:1fr}.footer-bottom{display:block;margin-top:28px}.footer-legal{text-align:left;margin-top:8px}.nav-dropdown-menu{min-width:min(330px,88vw)!important}}
    `;
  ...
  const isCoursePage = () => {
    ...
    return coursePaths.some((p) => path.startsWith(p));
  };
  ...
  const renderFooter = () => {
    ...
    const courseInfoBlock = isCoursePage() ? `
      <div class="footer-course-info" aria-label="課程交易與履約資訊">
        <p class="footer-course-kicker">Consumer Information</p>
        <div class="footer-course-title">課程交易與履約資訊</div>
        <div class="footer-course-grid">
          <div class="footer-course-item"><strong>服務屬性</strong>預約制實體課程；採單次購買，非訂閱制、非儲值式服務。</div>
          <div class="footer-course-item"><strong>上課方式</strong>實體授課。完成付款後依預約網站開放日期選擇上課日期與時段。</div>
          <div class="footer-course-item"><strong>最長履約效期</strong>未指定固定日期之課程，原則上應自付款日起 180 日內完成預約及課程；固定場次則以所選場次日期為履約日。個別課程另有公告者，依該課程公告為準。</div>
          <div class="footer-course-item"><strong>取消、改期與退款</strong>依本站「退換貨與退款政策」及中華民國相關消費者保護法令辦理。</div>
        </div>
      </div>` : "";
